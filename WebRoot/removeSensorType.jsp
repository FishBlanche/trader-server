...
<head>
    ...
    <title><fmt:message key="Title-removeSensorType"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent"> 
	                       		<li><h1><fmt:message key="removeSensorType_Welcome_to_Remove_SensorType"></fmt:message></h1></li> 
	                       		...
	                       		<li><div class="hr"></div></li> 
	                       		<li><a href="javascript:form.action='dataSource?dealtype=removeSensorType';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Remove_it"></fmt:message></a>
