...
<head>
    ...
    <title><fmt:message key="Title-modifyDirector"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent">
	                       		<li><h1><fmt:message key="modifyDirector_Welcome_to_Modify"></fmt:message></h1></li>
	                       		...
	                       		<li><a name="submit" href="javascript:form.action='dataSource?dealtype=modify';form.submit();" class="button grey"><fmt:message key="Proceed"></fmt:message></a></li>																		
	                       	</ul>
	                    </form>			 					
                        <br /><br /><br /><br /><br /><br /> 
                        <br /><br /><br /><br /><br /><br /> 
