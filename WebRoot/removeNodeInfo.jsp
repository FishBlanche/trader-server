...
<head>
    ...
    <title><fmt:message key="Title-removeNodeInfo"></fmt:message></title>  
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent"> 
	                       		<li><h1><fmt:message key="removeNodeInfo_Welcome_to_Remove_NodeInfo"></fmt:message></h1></li> 
	                       				...
	                       				<div class="row">			 
	                       					...
	                       					<div class="sensorNameDes">			 
	                   							 <fieldset class="checkboxes"> 	
	                   							 	<c:forEach items="${nodeDBBean.nodeInfoList}" var="current">
		                       							<label class="label_check"> 
		                       								<h3><c:out value="${current.moteid_ID}"></c:out></h3>					
		                       								<img name="${current.moteid_ID}" src="images/unselectedCheckbox.gif" />	
		                       							</label> 
		                       							<br/> 						
		                       						</c:forEach>
	                       						 </fieldset>							
	                       		...
	                       		<li><div class="hr"></div></li> 
	                       		<li><a href="javascript:form.action='dataSource?dealtype=removeNodeInfo';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Remove_it"></fmt:message></a>
