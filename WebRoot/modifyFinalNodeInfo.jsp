...
<head>
    ...
    <title><fmt:message key="Title-modifyFinalNodeInfo"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent"> 
	                       		<li><h1><fmt:message key="modifyNodeInfo_Welcome_to_modify_NodeInfo"></fmt:message></h1></li> 					
	                       		...
	                       		<form method="post" name="form">		 
	                       			<div class="table form-fields"> 
	                       				<div class="row"> 
	                       					...
	                       					<div class="input">			 
	                       						<input name="moteid_ID" value="${nodeInfoBean.moteid_ID}" type="text" class="black" />  							 
	                       					</div>	 
	                       				</div>	 
	                       				 <div class="hr"></div>
										<div class="row"> 
	                       					...
	                       					<div class="input">			 
	                       						<input name="location_X" value="${nodeInfoBean.location_X}" type="text" class="black" />  							 
	                       					</div>	 
	                       				</div>	
	                       				<div class="hr"></div>	
	                       				<div class="row"> 
	                       					...
	                       					<div class="input">			 
	                       						<input name="location_Y" value="${nodeInfoBean.location_Y}" type="text" class="black" />  							 
	                       					</div>	 
	                       				</div>	
	                       				<div class="hr"></div>
	                       				<div class="row"> 
	                       					...
	                       					<div class="input">			 
	                       						<input name="latitude" value="${nodeInfoBean.latitude}" type="text" class="black" />  							 
	                       					</div>	 
	                       				</div>	
	                       				<div class="hr"></div>	
	                       				<div class="row"> 
	                       					...
	                       					<div class="input">			 
	                       						<input name="longitude" value="${nodeInfoBean.longitude}" type="text" class="black" />  							 
	                       					</div>	 
	                       				</div>	
	                       				<div class="hr"></div>	
	                       				<%-- <div class="row">			 
	                       					<div class="label">Related type</div>	 		
	                   							 ...
	                   							 <fieldset class="checkboxes"> 	
	                   							 	<c:forEach items="${nodeDBBean.nodeTypeList}" var="current">		
		                       							<label class="label_check"> 
		                       								<h3><c:out value="${current.nodeType}"></c:out></h3>	
		                       								<c:choose>				
		                       									<c:when test="${nodeInfoBean.isContainNodeInfo(current.nodeType)}">
		                       										<img name="${current.nodeType}" src="images/selectedCheckbox.gif" />
		                       									</c:when>
		                       									<c:otherwise>
		                       										<img name="${current.nodeType}" src="images/unselectedCheckbox.gif" />	
		                       									</c:otherwise>	
		                       								</c:choose>	
		                       							</label> 
		                       							<br/> 
	                       				...
	                       				<div class="row"> 
											...
											<div class="styled-select">
												<select name="nodeType" onchange="relateSensorNames(this)"> 
													<c:forEach items="${nodeDBBean.nodeTypeList}" var="current">		
														<c:choose>
															<c:when test="${nodeInfoBean.isEquals(current.nodeType)}">
												...
												<label class="label_check label_link label_align"> 		
	               									<h3><a href="javascript:form.action='createNodeType.jsp?createSession=2';form.submit();"><fmt:message key="more"></fmt:message>...</a></h3>	 					 
	               								</label>  		
											</div>
	                       				</div>	
	                       					...
	                       					<div class="input">
												...
												<span name="addValues">
													<span>
		                       							<br /> <br />
		                       							<c:choose>
			                       							<c:when test="${not empty nodeDBBean.findNodeTypeBean(nodeInfoBean.nodeType)}">
			                       								<c:forEach items="${nodeDBBean.relatedNode_Sensor(nodeInfoBean.nodeType)}" var="current">
	                       				...
	                       				<div class="row"> 
	                       					...
	                       					<div class="input"> 
												<textarea name="remarks" rows="10" cols="38" class="black">${nodeInfoBean.remarks}</textarea>							 
	                       					</div>		 
	                       				</div> 					
	                       			</div>	 
	                       		</form>	 
	                       		<li><div class="hr"></div></li> 
	                       		<li><a href="javascript:form.action='dataSource?dealtype=modifyNodeInfo';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Update_it"></fmt:message></a>
