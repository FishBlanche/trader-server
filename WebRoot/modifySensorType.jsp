...
<head>
    ...
    <title><fmt:message key="Title-modifySensorType"></fmt:message></title> 
                ...
                <div id="rightColumn">
                    ...
                    <div class="pageContent"> 
                       	<ul class="pageMainContent"> 
                       				...
                       				<div class="row"> 
										...
										<div class="styled-select">
											<select name="sensorName"> 
												...
												<option>
													<c:out value="${current.sensorName}"></c:out>		
												</option>		
												</c:forEach>
											</select>	
										</div>
                       		...
                       		<li><div class="hr"></div></li> 
                       		<li><a href="javascript:form.action='dataSource?dealtype=modifySensorTypeDir';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Proceed"></fmt:message></a></li>														 
                       	</ul>	 																			
                        <br /><br /><br /><br /><br /><br /> 
                        <br /><br /><br /><br /><br /><br /> 
                        <br /><br /><br /><br /><br /><br /> 
