...
<head>
    ...
    <title><fmt:message key="Title-createDirector"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent">
	                       		<li><h1><fmt:message key="createDirector_Welcome_to_Create"></fmt:message>	</h1></li>
	                       		...
	                       		<li><a name="submit" href="javascript:form.action='<%=basePath %>dataSource?dealtype=create';form.submit();" class="button grey"><fmt:message key="Proceed"></fmt:message></a></li>																		
	                       	</ul>
	                    </form>			 					
                        <br /><br /><br /><br /><br /><br /> 
                        <br /><br /><br /><br /><br /><br /> 
