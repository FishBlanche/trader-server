...
<head>
    ...
    <title><fmt:message key="Title-modifyFinalSensorType"></fmt:message></title> 
                ...
                <div id="rightColumn">
                    ...
                    <div class="pageContent"> 
                       	<ul class="pageMainContent"> 
                       		<li><h1><fmt:message key="modifySensorType_Welcome_to_Modify_SensorType"></fmt:message></h1></li> 
                       		...
                       		<form method="post" name="form">		 
                       			<div class="table form-fields"> 
                       				<div class="row"> 
                       					...
                       					<div class="input">			 
                       						<input name="sensorName" value="${sensorTypeBean.sensorName}" type="text" class="black" />  							 
                       					</div>	 
                       				</div>	 
                       				 <div class="hr"></div>	
                       				 ...
                       				 <div class="row"> 
                       					...
                       					<div class="input">			 
                       						<input name="unit" value="${sensorTypeBean.unit}" type="text" class="black" />  							 
                       					</div>	 
                       				</div>	 
                       				 <div class="hr"></div>	
                       				 ...
                       				 <div class="row"> 
                       					...
                       					<div class="input">			 
                       						<input name="range_low" value="${sensorTypeBean.rangeLow}" type="text" class="black" />  							 
                       					</div>	 
                       				</div>	 
                       				 <div class="hr"></div>	
                       				 ...
                       				 <div class="row"> 
                       					...
                       					<div class="input">			 
                       						<input name="range_high" value="${sensorTypeBean.rangeHigh}" type="text" class="black" />  							 
                       					</div>	 
                       				</div>	 
                       			</div>	 
                       		</form>	 
                       		<li><div class="hr"></div></li> 
                       		<li><a href="javascript:form.action='dataSource?dealtype=modifySensorType&sensorIndex=${sensorTypeBean.sensorName}';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Update_it"></fmt:message></a>
