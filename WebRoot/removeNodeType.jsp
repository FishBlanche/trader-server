...
<head>
    ...
    <title><fmt:message key="Title-removeNodeType"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent"> 
	                       		<li><h1><fmt:message key="removeNodeType_Welcome_to_Remove_NodeType"></fmt:message></h1></li> 
	                       		...
	                       		<li><div class="hr"></div></li>
	                       		<li>
	                       			<a href="javascript:form.action='dataSource?dealtype=removeNodeType';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Remove_it"></fmt:message></a>
