...
<head>
    ...
    <title><fmt:message key="Title-modifyNodeInfo"></fmt:message></title> 
                    ...
                    <div class="pageContent"> 
                    	<form name="form" method="post" action="">
	                       	<ul class="pageMainContent"> 
	                       			...
	                       			<div class="table form-fields"> 
	                       				<div class="row"> 
											...
											<div class="styled-select">
												<select name="moteid_ID"> 
													<option>--Choose--</option>
													<c:forEach items="${nodeDBBean.nodeInfoList}" var="current">
													<option>			
														<c:out value="${current.moteid_ID}"></c:out>		
													</option>		
													</c:forEach>
												</select>	
											</div>
	                       		...
	                       		<li><div class="hr"></div></li> 				
	                       		<li><a href="javascript:form.action='dataSource?dealtype=modifyNodeInfoDir';form.submit();" class="button grey" onclick="setCheckboxValues()"><fmt:message key="Proceed"></fmt:message></a></li>														 
	                       	</ul>
	                    </form>			 					
                        <br /><br /><br /><br /><br /><br />  
                        <br /><br /><br /><br /><br /><br /> 	
